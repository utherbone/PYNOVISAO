...
from tensorflow.keras.applications import (VGG16, VGG19, InceptionV3, MobileNet, Xception)
...
class PseudoLabel:
    ...
    def __init__(self,
        ...
        self.weight_path = os.path.abspath("../models_checkpoints/") + "/" + str(self.h5_filename) + ".h5"
